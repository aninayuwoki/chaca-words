...
const ALPHABET = [
  ...
  { letter: 'M', name: 'eme', words: [{ id: 'mama-abc', word: 'Mamá', keyword: 'madre' }, { id: 'mesa', word: 'Mesa' }, { id: 'manzana', word: 'Manzana' }, { id: 'mariposa', word: 'Mariposa' }] },
  ...
  { letter: 'P', name: 'pe', words: [{ id: 'papa-abc', word: 'Papá', keyword: 'padre' }, { id: 'perro', word: 'Perro' }, { id: 'pelota-abc', word: 'Pelota' }, { id: 'pan', word: 'Pan' }] },
